...
<div id="header"style="width:100vw; height:80px;;background-color: #000000; margin-bottom:650px;">
  ...
  <div id = "maint">
  <p class= "maina">Get Smart, Get Health</p>
  <p class= "mainb">당신의 운동을 계획하세요</p>
  	<c:if test ="${!empty member}">   
  		<button class="ui inverted button btn-goal" style = "width:150px;height:60px;font-size:1.2em;">하루 목표치 설정하기<img src="IMG/right-arrow.png" style = "width:15px;height:15px;magin-left:10px;"></button>
	</c:if> 
     ...
     <div class="ui header" align="center">로그인</div>
      <form action = "LoginCheck"  id="LoginCheck" method = "post">
         <div id="wire">
            ...
            <div id="skeleton22">
               <div class="frame22">
                  <div class="signUp"><div id="dd"><span id="span" style = "color:black;">new to us?</span> <a href="#" class="ss">Sign Up</a></div></div>
               </div>
            </div>
      </div>
      </form>
...
<div class="ui modal jo" id="wid22">
        ...
        <form action = "MemberJoin"  id="MemberJoin" method = "post">
            <div class="ui form">
               <div class="inline field" >
                 ...
                 <input type="email" placeholder="E-mail" id="emailcheck" name = "email" required>
                 <button type="button" id="btn22" onclick = "get()">중복확인</button>
               ...
               <div class="inline field">
                 ...
                 <input type="password" placeholder="Password" id="signup" name = "pw" required>
               </div>
       
               <div class="inline field">
                 <label><h4>이름&emsp;&emsp;&emsp;&emsp;&emsp;</h4></label>
                 <input type="text" placeholder="Name" id="signup2" name ="name" required>
               </div>
                 <div class="inline field">
                 <label><h4>연락처&emsp;&emsp;&emsp;&emsp;</h4></label>
                 <input type="tel" placeholder="Tel" id="signup3" name ="tel" required>
               </div>
           </div>
        </form>
  ...
  <div class="ui modal goal" id="widEn">
      <a href="5mainHeader.jsp" id="a"><i class="remove icon" id="ic"></i></a>
      <div class="image content">
         <div class="description" style="height: 150px;">
            <div class="ui header" align="center">오늘의 목표량 등록하기</div>
            <form action="SetGoal" id="SetGoal" method="post">
               <div id="wire">
                  <div id="skeletonEn">
                     <div class="frame11">
                        <div class="userImg">
                           <img src="IMG/goal.png" class="imgSize">
                        </div>
                        <div class="textA">
                           <input type="text" class="textSize" placeholder="목표량 입력" name = "goal">
                        </div>
                     </div>
                     <div class="frame11">
                        <div class="btn11">
                           <button type="submit" class="btnSize">등록하기</button>
                        </div>
                     </div>
                  </div>
               </div>
